...
(set -x; deploy_OM.bash ${omOptions})
...
(set -x; deploy_Cluster.bash ${oplogOptions})
...
(set -x; deploy_Cluster.bash ${blockstoreOptions})
...
(set -x; deploy_Cluster.bash ${rsOptions})
...
(set -x; deploy_Cluster.bash ${shOptions})
